...
function gameOver(a)
{
    var gameOverAlertElement = "<b>Oyun bitti </b><br><br> Oyuncu " + span[a].dataset.player.toUpperCase() + ' Kazandı !!! <br><br>' + restartButton;
...
function draw()
{
    var drawAlertElement = '<b>Berabere!!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
